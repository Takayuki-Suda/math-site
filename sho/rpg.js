...
(function(){
  ...
  if(!document.getElementById('rpgStyle')){
    ...
    st.textContent=
      ...
      '.rpg-toast-wrap{position:fixed;right:14px;bottom:18px;z-index:99990;display:flex;flex-direction:column;gap:8px;align-items:flex-end;pointer-events:none;}'+
