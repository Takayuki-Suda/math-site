...
(function(){
  ...
  /* ── レベル表（小学生〜研究者）── */
  /* レベルアップ必要XP（n→n+1）：200,400,700,1100、以降は差分+500ずつ（1600,2100,…）。
     下の xp は累計しきい値。レベルが上がりすぎないよう、獲得XPは addXP で半分にしている。 */
  var LEVELS=[
    /* 小学生 */
    {lv:1,  xp:0,     title:'見習い冒険者',   emoji:'🧒', msg:''},
    {lv:2,  xp:200,   title:'算数の戦士',     emoji:'⚔️', msg:'すごい！算数の力がついてきたね。一緒にもっと進もう。— 須田先生'},
    {lv:3,  xp:600,   title:'数学の魔法使い', emoji:'🧙', msg:'ここまで来たか。本物の力がついている。— 須田先生'},
    {lv:4,  xp:1300,  title:'伝説の数学者',   emoji:'👑', msg:'君は本物の数学者だ。いつでも会いに来てください。— 須田先生'},
    /* 中学生 */
    {lv:5,  xp:2400,  title:'数式の戦士',     emoji:'🗡️', msg:'文字という新しい武器を手に入れたな。数式は君の剣だ。— 須田先生'},
    {lv:6,  xp:4000,  title:'方程式の解読者', emoji:'📜', msg:''},
    {lv:7,  xp:6100,  title:'図形の騎士',     emoji:'🛡️', msg:''},
    {lv:8,  xp:8700,  title:'関数の魔法使い', emoji:'🔮', msg:'関数を自在に操れるようになった。世界の動きが、式で見えてくるはずだ。— 須田先生'},
    /* 高校生 */
    {lv:9,  xp:11800, title:'微分の騎士',     emoji:'♞',  msg:'高校数学の世界へようこそ。変化を斬る剣を授けよう。— 須田先生'},
    {lv:10, xp:15400, title:'積分の導師',     emoji:'🌀', msg:''},
    {lv:11, xp:19500, title:'極限の探究者',   emoji:'🔭', msg:''},
    {lv:12, xp:24100, title:'解析学の賢者',   emoji:'🦉', msg:'直感を超えて、厳密さの美しさが見え始めたな。— 須田先生'},
    /* 大学生 */
    {lv:13, xp:29200, title:'抽象の探求者',   emoji:'🚪', msg:'大学数学の扉を開いたか。ここからは概念そのものと戦う。— 須田先生'},
    {lv:14, xp:34800, title:'空間の旅人',     emoji:'🧭', msg:''},
    {lv:15, xp:40900, title:'構造の解読者',   emoji:'🗝️', msg:''},
    {lv:16, xp:47500, title:'定理の番人',     emoji:'🏛️', msg:'数学という建築物を、君はもう支える側にいる。— 須田先生'},
    /* 大学院 */
    {lv:17, xp:54600, title:'証明の錬金術師', emoji:'⚗️', msg:'証明は黄金より価値がある。それを生み出す力が君にはある。— 須田先生'},
    {lv:18, xp:62200, title:'予想に挑む者',   emoji:'🔥', msg:''},
    {lv:19, xp:70300, title:'理論の構築者',   emoji:'🌌', msg:''},
    {lv:20, xp:78900, title:'数論の覇者',     emoji:'🐉', msg:'ここまで歩いてきた人間を、私はほとんど知らない。— 須田先生'},
    /* 研究者（これ以降は称号なし・∞） */
    {lv:21, xp:88000, title:'未知への挑戦者', emoji:'♾️', msg:'ここから先に称号はない。あるのは、誰も知らない問いだけだ。君の旅は無限に続く。— 須田先生'}
  ];
  var INF_BASE=88000, INF_STEP=10000; /* Lv21以降は10000XPごとにレベルだけ上がり続ける */
  ...
  /* ── XP加算 ──
     獲得XPは半分に調整（敵撃破・ボス撃破・知識カード・クイズ正解など、addXP を通る全獲得が対象）。
     敵/ボス/カードのXP量は他ファイルから渡ってくるため、ここで一括して半減するのが唯一の窓口。 */
  function addXP(n,label){
    n=Math.max(1,Math.round(n*0.5));
